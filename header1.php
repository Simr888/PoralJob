...
<body>
  <nav class="navbar sticky-top navbar-expand-lg bg-dark-subtle fixed-top">
    <div class="container">
      <div class="col-md-3">
      ...
      <div class="col-md-7 d-none d-lg-flex"> <!-- Visible only on large screens -->
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active text-dark" aria-current="page" href="front.php">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-dark" href="find.php">Find a job</a>
          </li>
          <li class="nav-item">
      ...
      <div class="col-md-2 d-none d-lg-flex "> <!-- Visible only on large screens -->
        <a href="log_in.php" class="btn btn-outline-success me-2" type="submit">Log-in</a>
